...
<ul>
  ...
  <li ><a  href="#"></a>Manage User</li>
  <li><a href="index.jsp?msg=You are Logged out!">Logout</a>
</ul>
</div>
...
<table cellspacing=20 > 
 ...
 <tr>
   ...
   <td><input type="date" name="releasedate" required="required"></td>
 </tr>
...
<label style="color: red;padding-left:60px; margin-top:40px">
