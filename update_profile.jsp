...
<div>
<h2 align="center"; style="margin-top: 3%";>Welcome,<%=session.getAttribute("user")%></h2>
...
<table cellspacing=20; border="1";>
	<tr>
	<td><label style="color:red";>Username:</label></td>
	<td><input type="text" name="user" value="<%=u%>" required="required" readonly="readonly"></td>
	</tr>
	
	<tr>
	<td><label style="color:red">Password:</label></td>
	<td><input type="text" name="pass" value="<%=p%>" required="required"></td>
	</tr>
	
	<tr>
	<td><label style="color:red">Email:</label></td>
	<td><input type="email" name="email" value="<%=e%>" required="required"></td>
	</tr>
	
	<tr>
	<td><label style="color:red">Mobile:</label></td>
	<td><input type="number" name="mobile" value="<%=m%>" required="required"></td>
	</tr>
	
	
	<tr>
	<td size="1";><input type="submit" value="Update"></td>
